                        ...
                        */
                        ...
                        foreach ($tenantRows as $tenantRow) {
                            ...
                            $sq_tenants="INSERT into `tenants`
                                (`houseNumber`,`partition_id`,`tenant_name`,`email`,`ID_number`,`profession`,`phone_number`,`tenant_address`,`tenant_home_country_address`,`tenant_country`,`start_date`,`end_date`,`tenant_status`,`dateAdmitted`) values('$houseid','$partitionId','$tname','$temail','$idnum','$prof','$phone','$tenantAddress','$tenantHomeCountryAddress','$tenantCountry','$startDate','$endDate','Active','$dateAdmitted');";
                        ...
                        $mysqli->query($sql_transactions)?null: $status=false;
                            ...
                            else
                            {
                                ...
                                header('location:new-tenant.php?state=4'.($dateError ? '&date_error=1' : ''));
                            }
                                    ...
                                    <form action="new-tenant.php" method="post">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="number" min="1" max="20" value="1" required class="form-control" id="tenant_count"> </div>
                                        </div>
