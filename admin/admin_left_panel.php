                ...
                <ul class="nav" id="side-menu">
                    ...
                    <li> <a href="#" class="waves-effect"><i class="fa fa-building fa-2x"></i> <span class="hide-menu"> || Houses<span class="fa arrow"></span></span></a>
                        <ul class="nav nav-second-level">
                            ...
                            <?php } ?>
                            <li><a href="add-partition.php"><?php echo is_admin_user() ? 'Add Partition' : 'View Partitions'; ?></a></li>
                            <li><a href="houses.php"><?php echo $tenantUser ? 'Available Partitions' : 'View Houses'; ?></a></li>
                        </ul>
                    </li>
                    ...
                    <li><a href="#" class="waves-effect"><i class="fa fa-users fa-2x"></i> <span class="hide-menu"> || Tenants<span class="fa arrow"></span></span></a>
                        <ul class="nav nav-second-level">
                            ...
                            <li><a href="deleted-tenants.php">Deleted / Moved Out</a></li>
                        </ul>
                    </li>
                    <?php } ?>
                    ...
                    <li><a href="#" class="waves-effect"><i class="fa fa-credit-card fa-2x"></i> <span class="hide-menu"> || Invoices <span class="fa arrow"></span></span></a>
                        <ul class="nav nav-second-level">
                            ...
                            <?php } ?>
                            <li><a href="invoices.php"><?php echo $tenantUser ? 'My Invoices' : 'View invoices'; ?></a></li>
                        </ul>
                    </li>
                    ...
                    <li><a href="complaints.php" class="waves-effect"><i class="fa fa-wrench fa-2x"></i> <span class="hide-menu">  ||  <?php echo is_admin_user() ? 'Complaints' : 'My Complaints'; ?></span></a>
                    </li>
