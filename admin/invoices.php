<?php
   ...
   */
   ...
   if ($canManageInvoices) {
       ...
       $sql="select * from `invoicesView` where `tenantID`='$tenantId'";
   }
                                ...
                                <table id="example23" class="display nowrap" cellspacing="0" width="100%">
                                    ...
                                    echo '
                                        ...
                                        <tr>
                                            ...
                                            <td>'.$row["status"].'</td>
                                            <td>'.$row["comment"].'</td>
                                            '.($canManageInvoices ? '<td><a href="#"><i class="fa fa-tras"  data-toggle="modal" data-target="#responsive-modal'.$row["invoiceNumber"].'" title="delete" style="color:red;"></i></a></td>' : '').'
                                       

                                            '.($canManageInvoices ? '<!-- /.modal -->
