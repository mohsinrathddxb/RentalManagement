(function($) {
    ...
    if (typeof Morris !== 'undefined' && hasElement('morris-area-chart')) {
        Morris.Area({
    ...
    if (typeof Morris !== 'undefined' && hasElement('morris-area-chart2')) {
        Morris.Area({
    ...
    $(document).ready(function() {
        var sparklineLogin = function() {
            ...
            if ($('#sparkline2dash').length && $.fn.sparkline) {
