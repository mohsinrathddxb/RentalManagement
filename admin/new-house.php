                       ...
                       if (isset($_POST['submit'])) {
                        ...
                        $timesnap=date('Y-m-d : H:i:s');
                            ...
                            if ($state) {
                                $mysqli->commit();
                                $uploadedPhotos = 0;
                                if ($newHouseId && !empty($_FILES['house_photos']['name'][0])) {
                            ...
                            <div class="row">
                                <div class="col-sm-12 col-xs-12">
                                    <form action="new-house.php" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            <label for="house_photos">House Image(s):</label>
                                            <div class="input-group">
                                            ...
                                            <small class="text-muted">Optional. These will be saved as House photos. Allowed: JPG, PNG, GIF, WEBP. Max 5MB per image.</small>
                                        </div>
